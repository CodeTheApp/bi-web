    ...
    >
      <div className='container gap-3 flex flex-col items-center'>
        <header className='mb-6'>
          <h1 className='text-3xl font-bold text-gray-500'>Serviços</h1>
        </header>

        <div className='w-full p-10 bg-white bg-opacity-80 shadow-shape rounded-2xl'>
          <div className='flex flex-col gap-3 w-full'>
            <h1 className='text-xl font-semibold text-gray-500'>
              Projetos de Iluminação
            </h1>
            <ul className='pl-6 space-y-2'>
              <li className='text-gray-500 relative text-base before:absolute before:top-2 before:left-[-1.25rem] before:w-2 before:h-2 before:bg-orange before:rounded-full'>
        ...
        <div className='w-full p-10 bg-white bg-opacity-80 shadow-shape rounded-2xl'>
          <div className='flex flex-col gap-3 w-full'>
            <h1 className='text-xl font-semibold text-gray-500'>Consultoria</h1>
            <ul className='pl-6 space-y-2'>
              <li className='text-gray-500 relative text-base before:absolute before:top-2 before:left-[-1.25rem] before:w-2 before:h-2 before:bg-orange before:rounded-full'>
